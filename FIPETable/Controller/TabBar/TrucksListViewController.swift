...
class TrucksListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Task(priority: .background) {
            await viewModel.fetchVehicleBrands(vehicleType: "caminhoes")
...
extension TrucksListViewController: UITableViewDelegate, UITableViewDataSource {
...
extension TrucksListViewController: UISearchResultsUpdating, UISearchBarDelegate {
