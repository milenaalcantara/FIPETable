...
class MotorcyclesListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Task(priority: .background) {
            await viewModel.fetchVehicleBrands(vehicleType: "motos")
...
extension MotorcyclesListViewController: UITableViewDelegate, UITableViewDataSource {
...
extension MotorcyclesListViewController: UISearchResultsUpdating, UISearchBarDelegate {
